...
//    const FloatType nearfield_convergence_threshold_ = std::pow(10, -MULTI_PRECISION/2);

    // For near-field evaluation we use Le Ru cutoff which is valid only for double precision,
    // so convergence threshold is the same
